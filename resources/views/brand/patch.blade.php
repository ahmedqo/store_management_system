...
@section('title', ucwords(__('Update Brand')) . ' #' . $data->id)

@section('content')
    <div class="flex flex-col gap-4">
        <div class="w-full flex items-center justify-between gap-2">
            <h1 class="font-x-core text-2xl">{{ ucwords(__('Update Brand')) }} #{{ $data->id }}</h1>
            <div
                ...
                <div class="container mx-auto lg:w-max p-4 lg:p-0">
                    <div
                        ...
                        <form action="{{ route('actions.brands.clear', $data->id) }}" method="POST">
                            @csrf
                            @method('delete')
                            <button type="submit"
